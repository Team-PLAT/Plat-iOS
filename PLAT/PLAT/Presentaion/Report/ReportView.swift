...
struct ReportView: View {
    ...
    var body: some View {
        VStack {
            ...
            ReportSectionView(reportList: $reportList, isReportAlertPresented: $isReportAlertPresented)
        ...
        .alert("트랙을 신고하시겠어요?", isPresented: $isReportAlertPresented) {
            ...
            Button("신고하기", role: .destructive) {
                Task {
                    ...
                    trackUseCase.effect(.reportTrack(trackId: trackId))
...
private struct ReportInfoView: View {
